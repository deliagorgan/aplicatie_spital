                ...
                <div class="col-xl-9 mx-auto">
                    <div class="cta-inner content-normal text-right rounded">
                        <h2 class="section-heading mb-12">
                            <span class="section-heading-lower"><b>Adaugă o internare</b></span><br>
                        </h2>
                        <form action="insert_int.php" method="post">
                            <fieldset>
                                <label for="IdInternare">ID: <input type="text" name="IdInternare" placeholder="01234" required></label><br>
                                <label for="Numar">Numar: <input type="number" name="Numar" placeholder="001" required></label><br>
                                <label for="Fisa">Id Fisa: <input type="number" name="Fisa" placeholder="001" required></label><br>
                                <label for="DataInternarii">Data Internare: <input type="date" name="DataInternarii" placeholder="AAAA-LL-ZZ" required></label><br>
                                <label for="DataExternarii">Data Externare: <input type="date" name="DataExternarii" placeholder="AAAA-LL-ZZ" required></label><br>
                            </fieldset>
