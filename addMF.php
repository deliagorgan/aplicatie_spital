                ...
                <div class="col-xl-9 mx-auto">
                    <div class="cta-inner content-normal text-right rounded">
                        <h2 class="section-heading mb-12">
                            <span class="section-heading-lower"><b>Adaugă o fișă medicală</b></span><br>
                        </h2>
                        <form action="insert_mf.php" method="post">
                            <fieldset>
                                <label for="Numar">Numar Fișă: <input type="text" name="Numar" placeholder="01234" required></label><br>
                                <label for="IdFisa">Id: <input type="text" name="IdFisa" placeholder="001" required></label><br>
                                <label for="Medic">Medic: <input type="text" name="Medic" placeholder="001" required></label><br>
                                <label for="Pacient">Pacient: <input type="text" name="Pacient" placeholder="001" required /></label><br>
