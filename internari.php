...
<body>
          ...
          <li class="nav-item px-lg-4 dropdown">
            ...
            <div class="dropdown-content">
              <ul>
                ...
                <li><a class="nav-link text-uppercase text-expanded" href="addInt.php">Adaugă internări</a></li>
          </li>
      </div>
  ...
  if ($result->num_rows > 0) {
    ...
    echo "<tr><th class=\"title\" colspan=\"5\">Internari</th></tr>";
    echo "<tr><th>IdInternare</th><th>Numar</th><th>DataInternarii</th><th>DataExternarii</th><th>";

    // Butonul este plasat într-o celulă a tabelului
    echo "<button onclick=\"location.href='addInternare.php'\">➕Internare</button>";
    ...
    while ($row = $result->fetch_assoc()) {
      ...
      echo "<tr><td>" . $row["IdInternare"] . "</td><td>" . $row["Numar"] . "</td>   <td>" . $row["DataInternarii"] . "</td>    <td>" . $row["DataExternarii"] . "</td>    <td><a href='delete_int.php?Numar=" . $row['Numar'] . "' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a></td></tr>";
    }
    echo "</table>";
  } else {
    echo "0 results";
