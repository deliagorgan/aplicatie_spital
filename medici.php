...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
    <div class="container">
      ...
      <!-- <li class="nav-item px-lg-4">
      <a class="nav-link text-uppercase text-expanded" href="addPacient.php">Programări</a>
    </li> -->
      <li class="nav-item px-lg-4">
  ...
  if ($result->num_rows > 0) {
    ...
    echo "<tr><th class=\"title\" colspan=\"7\">MEDICI</th></tr>";
    echo "<tr><th>Nume</th><th>Prenume</th><th>Grad</th><th>Specializare</th><th>Sectie</th><th>CNP</th><th>";
    // Butonul este plasat într-o celulă a tabelului
    echo "<button onclick=\"location.href='addMedic.php'\">➕Medic</button>";
    ...
    while ($row = $result->fetch_assoc()) {
      ...
      echo "<tr><td>" . $row["Nume"] . "</td><td>" . $row["Prenume"] . "</td><td>" . $row["Grad"] . "</td><td>" . $row["Specializare"] . "</td><td>" . $row["Sectie"] . "</td><td>" . $row["CNP"] . "<td><a href='delete_med.php?CNP=" . $row['CNP'] . "' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a></td></tr>";
    }
    echo "</table>";
  } else {
    echo "0 results";
